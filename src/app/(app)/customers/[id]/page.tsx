...
import type { Customer, CustomerSale, LedgerEntry } from "@/lib/types";
...
export default function CustomerDetailPage() {
  ...
  const [sale, setSale] = useState({ total: "10000", paid_amount: "6000", payment_method: "cash", notes: "" });
  const [pay, setPay] = useState({ amount: "", method: "cash", notes: "" });

  async function load() {
    const [c, led, sl] = await Promise.all([
